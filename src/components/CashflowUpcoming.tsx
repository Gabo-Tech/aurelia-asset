        ...
        dayKeys.map((key) => {
          ...
          return (
            <View key={key} style={styles.dayBlock}>
              <Text style={[styles.dayHead, { color: colors.muted }]}>
                {dayHeading(date, t)}
              </Text>
              {items.map((e) => (
                <UpcomingRow
...
function UpcomingRow({
  ...
  const toneColor = isIncome ? colors.income : colors.expense;
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => [
        ...
        pressed && onEdit && styles.rowPressed,
      ]}
    >
      <Text style={[styles.arrow, { color: toneColor }]}>
        {isIncome ? "↑" : "↓"}
      </Text>
      ...
      <Text style={[styles.rowAmount, { color: toneColor }]}>
        {isIncome ? "+" : "−"}
        {mask(value)}
      </Text>
    </Pressable>
  ...
  return (
    <View style={styles.chip}>
      ...
      <Text
        style={[
          styles.chipValue,
          { color: tone === "income" ? colors.income : colors.expense },
        ]}
      >
        {value}
      </Text>
