...
const pt: Translation = {
  ...
  assistant: {
    ...
    ttsError: "Não foi possível reproduzir a voz. Transfira TTS novamente em Definições se faltar espeak-ng-data.",
    sessionTimeout: "Entrada de voz expirada. Toque no microfone e tente novamente.",
